...
2. **Apply Project Standards**: Follow the coding standards in the project's CLAUDE.md (or equivalent) and the conventions visible in the surrounding code: module and import style, function style, type annotations, error handling, and naming.
